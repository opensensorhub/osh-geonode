...
from geonode.contrib.opensensorhub.api import LayerResource
...
from geonode.contrib.opensensorhub.api import PointMarkerStylerResource
...
class ExplorerView(View):
    ...
    def get(self, request):
        ...
        resources = {HubResource.Meta.resource_name,
                     ...
                     LayerResource.Meta.resource_name,
                     VideoStylerResource.Meta.resource_name,
                     ChartStylerResource.Meta.resource_name,
                     PointMarkerStylerResource.Meta.resource_name,
        ...
        elements = [HubResource(), ObservationResource(),
                    LayerResource(), VideoStylerResource(),
                    ChartStylerResource(), PointMarkerStylerResource(),
